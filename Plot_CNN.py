...
print('xxxx data: {}'.format(datas.shape[0]))
print('xxxx training size: {}'.format(training_size))
...
'''
model.load_weights('weights/bitcoin2015to2017_close_CNN_2_relu-44-0.00023.hdf5')
